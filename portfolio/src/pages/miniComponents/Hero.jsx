  ...
  return (
    <div className="w-full">
      ...
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["PEGA SOLUTION ARCHITECT", "PEGA PRESALES CONSULTANT", "FULLSTACK DEVELOPER"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        <Link to={"https://www.youtube.com/channel/UCiU7-qGa4lDr0OtyE7egWDw"} target="_blank">
          <Youtube className="text-red-500 w-7 h-7"/>
        </Link>
        <Link to={"https://www.instagram.com/amitaabhdaas?igsh=MTJ6cGVvYmN4dzU0cA=="} target="_blank">
          <Instagram className="text-pink-500 w-7 h-7" />
        </Link>
        <Link to={"https://www.facebook.com/asdfggfdsa0987667890?mibextid=ZbWKwL"} target="_blank">
          <Facebook className="text-blue-800 w-7 h-7" />
        </Link>
        <Link to={"https://www.linkedin.com/in/amitabh-das-55378428?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"} target="_blank">
      ...
      <div className="mt-4 md:mt-8 lg:mt-10  flex gap-3">
        <Link to={"https://github.com/amitabhdas96"} target="_blank">
